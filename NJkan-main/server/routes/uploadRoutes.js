...
import { uploadmeme ,songInfo,SingleSongInfo,getAllSongs,searchSong,deleteSong, editSong,userInfo,approveSong,getAllUnverifiedSongs,getSongsForAdmin,searchSongForAdmin,downloadCounter,getAdminDashboard,getTrendingSongs,getRandomSongs,getSignUrl} from "../controllers/uploadController.js";


router.route("/uploadmeme").post(uploadmeme);
